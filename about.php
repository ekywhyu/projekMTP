		...
		<div id="wrapper" class="container">
			...
			<section class="main-content">
				<div class="row">
					<div class="span12">													
						<div class="row">
							<div class="span12">
							<img class="pageBanner" src="themes/images/pageBanner1.jpeg" alt="New products" >
				<h4 class="title">
									<span class="pull-left"><span class="text"><span class="line"><strong>Tentang Kami</strong></span></span></span>
			...
			<section>
				...
				<h5>CONTACT PERSON</h5>
							<p><strong>Nama    :</strong>&nbsp;<?=$data['anama']; ?><br>
							<p><strong>Phone 1 :</strong>&nbsp;<?=$data['anomer']; ?><br>
							<p><strong>Phone 2 :</strong>&nbsp;<?=$data['anomer1']; ?><br>
							<p><strong>Email   :</strong>&nbsp;<a href="#"><?=$data['aemail']; ?><br>
											
							</p>
							<?php } ?>
							<p class="logo"><a href="https://www.instagram.com/viea_craftjogja/"><img src="themes/images/instagram.png" class="site_logo" width="50px" height="50px" alt="">VIEA CRAFT JOGJA</p></a>
							<br/>
